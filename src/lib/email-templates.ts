          ...
          <tr>
            <td style="background-color:#ffffff;padding:48px 40px 40px;">
              ...
              <p style="margin:28px 0 0;font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:15px;color:#3d3d3d;line-height:1.6;">
                ${meetLink
                  ? "This call will be held over Google Meet. The button below joins at the scheduled time, and the same link is on the calendar invite you'll receive separately."
                  : "We'll follow up with call details before your appointment."}
                ${manageUrl
                  ? ` Need to reschedule or cancel? <a href="${manageUrl}" style="color:#5b9a2f;">Manage your booking</a>.`
                  : " Need to reschedule or ask a question? Just reply to this email."}
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:32px auto 0;">
                <tr>
                  <td align="center" style="border-radius:6px;background-color:#5b9a2f;">
                    <a href="${meetLink || SITE_URL}" target="_blank" style="display:inline-block;padding:14px 32px;font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:6px;">
                      ${meetLink ? "Join Google Meet" : "Visit Our Website"}
                    </a>
                  </td>
                </tr>
              </table>
...
// Shared chrome for the two booking lifecycle emails below (reschedule/cancel).
// bookingConfirmationEmail keeps its own inline copy above rather than moving
// onto this shell, to avoid touching an already-shipping template.
function bookingLifecycleEmail({
  iconGlyph,
  iconColor,
  iconBg,
  heading,
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border-radius:8px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background-color:#ffffff;padding:48px 40px 40px;">
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 24px;">
                <tr>
                  <td align="center" style="width:56px;height:56px;border-radius:50%;background-color:${iconBg};">
                    <span style="font-size:28px;line-height:56px;color:${iconColor};">${iconGlyph}</span>
                  </td>
                </tr>
              </table>
              <h1 style="margin:0 0 8px;text-align:center;font-family:'Playfair Display',Georgia,'Times New Roman',serif;font-size:26px;font-weight:600;color:#1a1a1a;line-height:1.3;">
          ...
          <tr>
            <td style="background-color:#1a1a1a;padding:32px 40px;text-align:center;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 16px;">
                <tr><td style="width:40px;height:1px;background-color:#f5a623;"></td></tr>
              </table>
              <p style="margin:0;font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:11px;color:rgba(255,255,255,0.35);line-height:1.6;">
                &copy; ${new Date().getFullYear()} Be Nice Hospitality Group. All rights reserved.
              </p>
        ...
        <td style="padding:28px 32px;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:14px;">
            <tr>
              ...
              <td style="font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:15px;color:#1a1a1a;line-height:1.4;">
                <span style="color:#3d3d3d;font-size:13px;">Date</span><br /><strong>${formattedDate}</strong>
              </td>
            </tr>
          </table>
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td width="28" valign="top" style="padding-top:2px;"><span style="font-size:16px;">&#128336;</span></td>
              <td style="font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:15px;color:#1a1a1a;line-height:1.4;">
                <span style="color:#3d3d3d;font-size:13px;">Time</span><br /><strong>${formattedTime}</strong> (${durationLabel})
              </td>
            </tr>
          </table>
        </td>
...
export function bookingRescheduledEmail({
  ...
  const footer = `
    <p style="margin:28px 0 0;font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:15px;color:#3d3d3d;line-height:1.6;">
      ${meetLink ? "The same Google Meet link still works for the new time." : ""}
      ${manageUrl ? `Need to change it again? <a href="${manageUrl}" style="color:#5b9a2f;">Manage your booking</a>.` : "Just reply to this email with any questions."}
    </p>`;
  return bookingLifecycleEmail({
    iconGlyph: "&#128197;",
    iconColor: "#5b9a2f",
    iconBg: "rgba(91,154,47,0.1)",
    heading: "Your Call Has Been Rescheduled",
    greetingName: name,
    bodyHtml: "Your discovery call with Be Nice Hospitality Group has a new time. Here are the updated details:",
    detailsHtml: bookingDetailsCard({ formattedDate, formattedTime, durationLabel }),
    footerHtml: footer,
  });
}
...
export function bookingCancelledEmail({
  ...
  const footer = `
    <p style="margin:28px 0 0;font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:15px;color:#3d3d3d;line-height:1.6;">
      Want to find a new time? <a href="${SITE_URL}/book" style="color:#5b9a2f;">Book another call</a>, or just reply to this email.
    </p>`;
  return bookingLifecycleEmail({
    iconGlyph: "&#10005;",
    iconColor: "#c0674a",
    iconBg: "rgba(192,103,74,0.1)",
    heading: "Your Call Has Been Cancelled",
    greetingName: name,
    bodyHtml: `Your discovery call with Be Nice Hospitality Group, previously scheduled for ${formattedDate} at ${formattedTime}, has been cancelled.`,
    detailsHtml: "",
    footerHtml: footer,
  });
}
