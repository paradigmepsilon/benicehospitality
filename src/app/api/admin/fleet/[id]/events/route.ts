...
import { logEvent } from "@/lib/fleet/engagements";

// The kinds an admin can log by hand. Stage, vehicle, and money entries are
// written by the engagement functions so they always match a real change to
// a row.
