...
import EarningsPlanOptimizer from "@/components/resources/earnings-plan-optimizer/EarningsPlanOptimizer";

const SITE_URL = "https://benicehospitality.com";
const tool = getResourceTool("earnings-plan-optimizer")!;

export const metadata: Metadata = {
  title: { absolute: `${tool.name}: Free 2026 Turo Plan Comparison | BNHG` },
  ...
  return (
    <ResourceToolLayout tool={tool} access={access}>
      <ResourceGate slug={tool.slug} toolName={tool.name} access={access}>
        <EarningsPlanOptimizer canSync={access.canSync} />
      </ResourceGate>
    </ResourceToolLayout>
  );
}
