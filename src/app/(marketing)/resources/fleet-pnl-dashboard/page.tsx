...
import FleetPnlDashboard from "@/components/resources/fleet-pnl-dashboard/FleetPnlDashboard";

const SITE_URL = "https://benicehospitality.com";
const tool = getResourceTool("fleet-pnl-dashboard")!;

export const metadata: Metadata = {
  title: { absolute: `${tool.name}: Free Turo Fleet P&L Tracker | BNHG` },
  ...
  return (
    <ResourceToolLayout tool={tool} access={access}>
      <ResourceGate slug={tool.slug} toolName={tool.name} access={access}>
        <FleetPnlDashboard canSync={access.canSync} />
      </ResourceGate>
    </ResourceToolLayout>
  );
}
