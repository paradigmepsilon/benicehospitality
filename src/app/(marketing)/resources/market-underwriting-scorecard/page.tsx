...
import MarketUnderwritingScorecard from "@/components/resources/market-underwriting-scorecard/MarketUnderwritingScorecard";

const SITE_URL = "https://benicehospitality.com";
const tool = getResourceTool("market-underwriting-scorecard")!;

export const metadata: Metadata = {
  title: { absolute: `${tool.name}: Free Turo Car Screening Tool | BNHG` },
  ...
  return (
    <ResourceToolLayout tool={tool} access={access}>
      <ResourceGate slug={tool.slug} toolName={tool.name} access={access}>
        <MarketUnderwritingScorecard canSync={access.canSync} />
      </ResourceGate>
    </ResourceToolLayout>
  );
}
