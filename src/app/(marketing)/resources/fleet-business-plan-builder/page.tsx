...
import FleetBusinessPlanBuilder from "@/components/resources/fleet-business-plan-builder/FleetBusinessPlanBuilder";

const SITE_URL = "https://benicehospitality.com";
const tool = getResourceTool("fleet-business-plan-builder")!;

export const metadata: Metadata = {
  title: { absolute: `${tool.name}: Free Car Rental Business Plan | BNHG` },
  ...
  return (
    <ResourceToolLayout tool={tool} access={access}>
      <ResourceGate slug={tool.slug} toolName={tool.name} access={access}>
        <FleetBusinessPlanBuilder canSync={access.canSync} />
      </ResourceGate>
    </ResourceToolLayout>
  );
}
