...
import PriceCalculator from "@/components/resources/room-rental-price-calculator/PriceCalculator";

const SITE_URL = "https://benicehospitality.com";
const tool = getResourceTool("room-rental-price-calculator")!;

export const metadata: Metadata = {
  title: { absolute: `${tool.name}: Free Per-Room Rent Estimator | BNHG` },
