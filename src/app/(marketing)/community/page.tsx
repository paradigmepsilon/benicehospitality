...
const COMMUNITY_FEATURES = [
  ...
  },
  {
    ...
    body: "Buy any Room Rental Riches tier (self-paced, Masterclass, or Operator) and you're in. Self-paced gets 1 year. Masterclass gets 1 year plus the live weeks. Operator gets lifetime.",
  },
  {
    title: "Asset-class threads",
    body: "Co-living and property operators post in their own threads. Fleet operators post in theirs. Multi-asset operators follow both. The signal stays high because the threads stay specific.",
  },
];
    ...
    <>
      <section className="bg-cream pt-32 md:pt-40 lg:pt-44 pb-12 md:pb-16 px-6 md:px-12 lg:px-20">
        <div className="max-w-4xl">
          ...
          <p className="font-sans text-lg md:text-xl text-charcoal leading-relaxed max-w-2xl mb-4">
            Our Facebook group is where live, founder-led sessions happen:
            Tuesday workshops, Thursday implementation hours, forty-seven
            weeks a year. Built for operators running co-living, short-term,
            mid-term, and long-term rentals, and Turo fleets.
          </p>
          <p className="font-sans text-base text-charcoal/70 leading-relaxed max-w-2xl mb-10">
            Access is bundled with every Room Rental Riches tier. It is not a
            paid membership on its own.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            {facebookGroupUrl ? (
              <Button href={facebookGroupUrl} external variant="primary" size="lg">
          ...
          {!facebookGroupUrl && (
            <p className="font-sans text-sm text-charcoal/60 mt-6">
              The group opens soon. Enroll in a course to be added the day it
              does.
            </p>
          )}
        </div>
          ...
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <AnimatedItem>
              <p className="font-sans text-lg text-charcoal/85 leading-relaxed">
                ...
                screaming match, or both. This one is the founders, live in
                the group, doing the work in real time.
              </p>
            </AnimatedItem>
          </div>
          <AnimatedDiv
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <AnimatedItem>
            <p className="font-sans text-lg text-white/85 leading-relaxed">
              The members in this group are running real operations: 3
