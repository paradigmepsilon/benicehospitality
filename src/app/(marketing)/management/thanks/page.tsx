...
// Landing page for the card-payment link an admin sends from the fleet
// tracker. Static on purpose: it shows nothing about the owner, so the URL is
// safe to land on with or without a session.
export default async function ManagementThanksPage({
  searchParams,
}: {
    ...
    <main className="mx-auto max-w-2xl px-6 py-24 text-center">
      ...
      <p className="mt-5 text-lg text-charcoal/80">
        {cancelled
          ...
          : "Your receipt is on its way from Stripe. Alex will be in touch within one business day with your welcome packet and the next step."}
      </p>
